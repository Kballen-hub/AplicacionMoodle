...
/**
   ...
   */Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.default=void 0,_ajax=_interopRequireDefault(_ajax),_modal=_interopRequireDefault(_modal),CustomEvents=function(obj,nodeInterop){if(!nodeInterop&&obj&&obj.__esModule)return obj;if(null===obj||"object"!=typeof obj&&"function"!=typeof obj)return{default:obj};var cache=_getRequireWildcardCache(nodeInterop);if(cache&&cache.has(obj))return cache.get(obj);var newObj={},hasPropertyDescriptor=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var key in obj)if("default"!==key&&Object.prototype.hasOwnProperty.call(obj,key)){var desc=hasPropertyDescriptor?Object.getOwnPropertyDescriptor(obj,key):null;desc&&(desc.get||desc.set)?Object.defineProperty(newObj,key,desc):newObj[key]=obj[key]}newObj.default=obj,cache&&cache.set(obj,newObj);return newObj}(CustomEvents),_notification=_interopRequireDefault(_notification);class AccessibilityModal extends _modal.default{static TYPE="theme_moove/themesettings_modal";static TEMPLATE="theme_moove/moove/accessibilitysettings_modal";constructor(root){super(root),_ajax.default.call([{methodname:"theme_moove_getthemesettings",args:{}}])[0].done((function(result){document.getElementById("fonttype").value=result.fonttype,result.enableaccessibilitytoolbar&&(document.getElementById("enableaccessibilitytoolbar").checked=!0)}))}registerEventListeners(){super.registerEventListeners(this),this.getModal().on(CustomEvents.events.activate,'[data-action="save"]',function(){_ajax.default.call([{methodname:"theme_moove_savethemesettings",args:{formdata:this.getBody().find("form").serialize()}}])[0].done((function(){document.location.reload(!0)})).fail(function(error){let message=error.message;message||(message=error.error),_notification.default.addNotification({message:message,type:"error"}),this.hide(),this.destroy()}.bind(this))}.bind(this)),this.getModal().on(CustomEvents.events.activate,'[data-action="cancel"]',function(){this.hide(),this.destroy()}.bind(this))}}return _exports.default=AccessibilityModal,_exports.default}));
